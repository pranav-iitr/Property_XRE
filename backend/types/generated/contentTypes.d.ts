...
export interface ApiFloorFloor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    floorArea: Attribute.Integer;
    totalUnitsInFloor: Attribute.Integer;
    numberAvailableUnits: Attribute.Integer;
...
export interface ApiPersonPerson extends Schema.CollectionType {
  ...
  attributes: {
    ...
    person_type: Attribute.Enumeration<
      ['Owner', 'Builder', 'Concerned Person', 'Caretaker']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiUnitUnit extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      ...
      >;
    unitNumber: Attribute.Integer;
    unitArea: Attribute.Integer;
    ...
    project: Attribute.Relation<
      ...
      'api::project.project'
    >;
    availabilityFor: Attribute.Enumeration<['lease', 'sale', 'both', 'none']>;
    askingRental: Attribute.Integer;
    furnishingStatus: Attribute.Enumeration<
      ['Furnished', 'Semi Furnished', 'Un Furnished']
    >;
    numberOfParkings: Attribute.Integer;
